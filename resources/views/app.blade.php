...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <!-- CSS -->
        <link href="./bbmcore/theme/css/app_1.min.css" rel="stylesheet">
        <link href="./bbmcore/theme/css/app_2.min.css" rel="stylesheet">
        <link href="./bbmcore/css/core.css" rel="stylesheet">
        <link href="./bbmcore/css/app.css" rel="stylesheet">
    </head>
